...
},{"./lib/DataSet":2,"./lib/network/Network":12}],2:[function(require,module,exports){
...
},{"./module/hammer":7}],6:[function(require,module,exports){
...
},{"dup":6,"hammerjs":33}],8:[function(require,module,exports){
...
module.exports = Edge;
},{"../util":31,"./Node":13}],10:[function(require,module,exports){
var util = require('../util');
...
},{"../DataSet":2,"../DataView":3,"../hammerUtil":5,"../module/hammer":7,"../shared/Activator":30,"../util":31,"./Edge":9,"./Groups":10,"./Images":11,"./Node":13,"./Popup":14,"./dotparser":15,"./gephiParser":16,"./locales":17,"./mixins/MixinLoader":21,"./shapes":29,"emitter-component":32,"keycharm":34}],13:[function(require,module,exports){
var util = require('../util');
...
function addButtonAction(element, action) {
  if (element.hammer==null) {
    element.hammer = Hammer(element, {prevent_default:false});
    element.hammer.on('tap', action);
  }
}
...
exports._toggleEditMode = function() {
  ...
  if (this.editMode == true) {
    ...
    addButtonAction(closeDiv, this._toggleEditMode.bind(this));
  }
  else {
    toolbar.style.display="none";
    closeDiv.style.display="none";
    editModeDiv.style.display="block";
    addButtonAction(closeDiv, null);
  }
  this._createManipulatorBar()
};
...
exports._createManipulatorBar = function() {
  ...
  if (this.editMode == true) {
    ...
    // bind the icons
    addButtonAction(this.manipulationDOM['addNodeSpan'], this._createAddNodeToolbar.bind(this));
    addButtonAction(this.manipulationDOM['addEdgeSpan'], this._createAddEdgeToolbar.bind(this));
    if (this._getSelectedNodeCount() == 1 && this.triggerFunctions.edit) {
      addButtonAction(this.manipulationDOM['editNodeSpan'], this._editNode.bind(this));
    }
    else if (this._getSelectedEdgeCount() == 1 && this._getSelectedNodeCount() == 0) {
      addButtonAction(this.manipulationDOM['editEdgeSpan'], this._createEditEdgeToolbar.bind(this));
    }
    if (this._selectionIsEmpty() == false) {
      addButtonAction(this.manipulationDOM['deleteSpan'], this._deleteSelected.bind(this));
    }
    addButtonAction(this.closeDiv, this._toggleEditMode.bind(this));
    ...
    addButtonAction(this.manipulationDOM['editModeSpan'], this._toggleEditMode.bind(this));
  }
};
...
exports._createAddNodeToolbar = function() {
  ...
  // bind the icon
  addButtonAction(this.manipulationDOM['backSpan'], this._createManipulatorBar.bind(this));
...
},{"../../module/Hammer":6,"../../util":31,"../Edge":9,"../Node":13}],21:[function(require,module,exports){
...
},{"./ClusterMixin":18,"./HierarchicalLayoutMixin":19,"./ManipulationMixin":20,"./NavigationMixin":22,"./SectorsMixin":23,"./SelectionMixin":24,"./physics/PhysicsMixin":27}],22:[function(require,module,exports){
var util = require('../../util');
var Hammer = require('../../module/hammer');
...
},{"../../module/hammer":7,"../../util":31}],23:[function(require,module,exports){
var util = require('../../util');
var Node = require('../Node');
...
},{"../../util":31,"../Node":13}],24:[function(require,module,exports){
var Node = require('../Node');
...
},{"../Node":13}],25:[function(require,module,exports){
/**
...
},{"../../../util":31,"./BarnesHutMixin":25,"./HierarchialRepulsionMixin":26,"./RepulsionMixin":28}],28:[function(require,module,exports){
/**
...
},{"../module/hammer":7,"../util":31,"emitter-component":32,"keycharm":34}],31:[function(require,module,exports){
// utility functions
...
},{"./module/moment":8}],32:[function(require,module,exports){
