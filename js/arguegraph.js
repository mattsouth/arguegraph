...
(function() {
  var ArgumentFramework, GroundedReasoner, Labelling, PreferredReasoner, Reasoner, complement, intersection, isSubset, powerset, root,
  ...
  Reasoner = (function() {
    function Reasoner(af1) {
      this.af = af1;
    }

    Reasoner.prototype.extensions = function() {
  ...
  GroundedReasoner = (function(superClass) {
    extend(GroundedReasoner, superClass);

    function GroundedReasoner() {
      return GroundedReasoner.__super__.constructor.apply(this, arguments);
    }

    GroundedReasoner.prototype.labellings = function() {
  ...
  PreferredReasoner = (function(superClass) {
    extend(PreferredReasoner, superClass);

    function PreferredReasoner() {
      return PreferredReasoner.__super__.constructor.apply(this, arguments);
    }

    PreferredReasoner.prototype.labellings = function() {
      var candidates, checkIn, findLabellings, transitionLabelling;
      checkIn = (function(_this) {
        return function(labelling) {
          var arg, defeater, illegallyIn, k, len, ref, result;
          illegallyIn = function(arg) {
            var defeater, k, len, ref;
            ref = _this.af.defeatermap[arg];
            for (k = 0, len = ref.length; k < len; k++) {
              defeater = ref[k];
              if (indexOf.call(labelling["in"], defeater) >= 0 || indexOf.call(labelling.undec, defeater) >= 0) {
                return defeater;
              }
            }
            return null;
      ...
      transitionLabelling = (function(_this) {
        return function(labelling, arg) {
          ...
          if (indexOf.call(illegallyOut, arg) >= 0) {
      ...
      findLabellings = (function(_this) {
        return function(labelling) {
          var arg, existing, illegals, k, l, len, len1, ok, ref, results;
