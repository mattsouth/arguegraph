...
(function() {
  var ArgumentFramework, GroundedReasoner, Labelling, PreferredReasoner, Reasoner, complement, intersection, isStrictSubset, isSubset, powerset, root,
    ...
    PreferredReasoner.prototype.labellings = function() {
      ...
      checkIn = (function(_this) {
        return function(labelling) {
          var illegal, illegals, k, legalDefeaters, legals, len, result, undecDefeater;
          undecDefeater = function(arg) {
            var defeater, k, len, ref;
          ...
          for (k = 0, len = illegals.length; k < len; k++) {
            ...
            if (legalDefeaters.length > 0 || undecDefeater(illegal)) {
